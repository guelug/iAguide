...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-pairing",
    "topic2": "concept 2 · openclaw-pairing",
    "topic3": "concept 3 · openclaw-pairing",
  ...
  "es": {
    "topic1": "Pairing son dos puertas",
    "topic2": "Pairing DM",
    "topic3": "Pairing de dispositivo y connect.challenge",
