...
const OPTIONS = [
  { value: "a" as const, label: "DM code", tone: "var(--teal)" },
  { value: "b" as const, label: "device", tone: "var(--teal)" },
  { value: "c" as const, label: "challenge", tone: "var(--amber)" },
  { value: "d" as const, label: "setup QR", tone: "var(--violet)" },
