...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-acp",
    "topic2": "concept 2 · openclaw-acp",
    "topic3": "concept 3 · openclaw-acp",
  ...
  "es": {
    "topic1": "Dos direcciones ACP, un nombre de protocolo",
    "topic2": "Bridge: openclaw acp",
    "topic3": "Spawn: acpx mas /acp",
