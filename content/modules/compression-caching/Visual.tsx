...
const OPTIONS = [
  ...
  { value: "flush" as const, label: "flush memory", tone: "var(--amber)" },
  { value: "middle" as const, label: "summarise", tone: "var(--violet)" },
  { value: "tail" as const, label: "keep tail", tone: "var(--teal)" },
  { value: "breakpoints" as const, label: "cache BPs", tone: "var(--amber)" },
];
