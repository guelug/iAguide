...
const COPY = {
  "en": {
    "topic1": "concept 1 · hermes-plugins",
    "topic2": "concept 2 · hermes-plugins",
    "topic3": "concept 3 · hermes-plugins",
  ...
  "es": {
    "topic1": "`register(ctx)` es la cintura de los plugins",
    "topic2": "Descubrimiento: user, proyecto, pip",
    "topic3": "La API de contexto, métodos con nombre",
