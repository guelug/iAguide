...
const COPY = {
  "en": {
    "topic1": "concept 1 · hermes-sessions",
    "topic2": "concept 2 · hermes-sessions",
    "topic3": "concept 3 · hermes-sessions",
  ...
  "es": {
    "topic1": "`state.db` es el transcript, no un montón JSON",
    "topic2": "El schema de un vistazo",
    "topic3": "FTS5 es cómo funciona `session_search`",
