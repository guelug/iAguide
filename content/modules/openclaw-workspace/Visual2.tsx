...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-workspace",
    "topic2": "concept 2 · openclaw-workspace",
    "topic3": "concept 3 · openclaw-workspace",
  ...
  "es": {
    "topic1": "El workspace es la casa del agente",
    "topic2": "Ubicacion por defecto",
    "topic3": "Archivos bootstrap (inyectados)",
