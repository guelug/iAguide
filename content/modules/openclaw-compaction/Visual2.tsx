...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-compaction",
    "topic2": "concept 2 · openclaw-compaction",
    "topic3": "concept 3 · openclaw-compaction",
  ...
  "es": {
    "topic1": "Los resumenes no son un session id nuevo",
    "topic2": "Auto, manual, flush",
    "topic3": "Calidad safeguard",
