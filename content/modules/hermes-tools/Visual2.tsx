...
const COPY = {
  "en": {
    "topic1": "concept 1 · hermes-tools",
    "topic2": "concept 2 · hermes-tools",
    "topic3": "concept 3 · hermes-tools",
  ...
  "es": {
    "topic1": "El registro es un rack, no un afterthought de ",
    "topic2": "Descubrimiento: AST primero, luego import",
    "topic3": "`check_fn` oculta la tool al modelo",
