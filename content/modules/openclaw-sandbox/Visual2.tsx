...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-sandbox",
    "topic2": "concept 2 · openclaw-sandbox",
    "topic3": "concept 3 · openclaw-sandbox",
  ...
  "es": {
    "topic1": "Tres controles, tres respuestas",
    "topic2": "Sandbox: donde corren las tools",
    "topic3": "Tool policy: que tools existen",
