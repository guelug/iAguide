...
const OPTIONS = [
  ...
  { value: "b" as const, label: "camera", tone: "var(--amber)" },
  { value: "c" as const, label: "screen", tone: "var(--violet)" },
  { value: "d" as const, label: "location", tone: "var(--amber)" },
  { value: "e" as const, label: "exec host", tone: "var(--teal)" },
];
