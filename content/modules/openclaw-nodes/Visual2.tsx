...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-nodes",
    "topic2": "concept 2 · openclaw-nodes",
    "topic3": "concept 3 · openclaw-nodes",
  ...
  "es": {
    "topic1": "Perifericos, no un segundo Gateway",
    "topic2": "Pairing y estado",
    "topic3": "Desfase de version",
