...
const OPTIONS = [
  { value: "a" as const, label: "embedded", tone: "var(--teal)" },
  { value: "b" as const, label: "agent RPC", tone: "var(--teal)" },
  { value: "c" as const, label: "Codex native", tone: "var(--violet)" },
  { value: "d" as const, label: "ACP spawn", tone: "var(--amber)" },
