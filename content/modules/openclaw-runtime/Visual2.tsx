...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-runtime",
    "topic2": "concept 2 · openclaw-runtime",
    "topic3": "concept 3 · openclaw-runtime",
  ...
  "es": {
    "topic1": "El loop embebido es el default",
    "topic2": "Dos familias de runtime",
    "topic3": "Superficies Codex comparten nombre",
