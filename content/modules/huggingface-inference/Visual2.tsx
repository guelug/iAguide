...
const COPY = {
  "en": {
    "topic1": "concept 1 · huggingface-inference",
    "topic2": "concept 2 · huggingface-inference",
    "topic3": "concept 3 · huggingface-inference",
  ...
  "es": {
    "topic1": "Cuatro formas de obtener el siguiente token, y",
    "topic2": "Inference Providers es un router, no un disco",
    "topic3": "Precios: cifra de Hermes, página de Hugging Fa",
