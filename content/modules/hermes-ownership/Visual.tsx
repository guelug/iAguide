...
const OPTIONS = [
  { value: "map" as const, label: "subsystem map", tone: "var(--teal)" },
  { value: "tests" as const, label: "tests mirror", tone: "var(--teal)" },
  { value: "narrow" as const, label: "narrower wins", tone: "var(--amber)" },
  { value: "waist" as const, label: "narrow waist", tone: "var(--violet)" },
  { value: "note" as const, label: "UI note", tone: "var(--amber)" },
];
