...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-tools",
    "topic2": "concept 2 · openclaw-tools",
    "topic3": "concept 3 · openclaw-tools",
  ...
  "es": {
    "topic1": "Tools, skills, plugins son tres nombres",
    "topic2": "Categorias builtin",
    "topic3": "Perfiles y luego allow/deny",
