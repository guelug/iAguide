...
const OPTIONS = [
  { value: "a" as const, label: "builtin", tone: "var(--teal)" },
  { value: "b" as const, label: "groups", tone: "var(--amber)" },
  { value: "c" as const, label: "plugins", tone: "var(--violet)" },
  { value: "d" as const, label: "skills", tone: "var(--teal)" },
  { value: "e" as const, label: "policy", tone: "var(--amber)" },
];
