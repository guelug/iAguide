...
const OPTIONS = [
  { value: "a" as const, label: "steer", tone: "var(--teal)" },
  { value: "b" as const, label: "followup", tone: "var(--teal)" },
  { value: "c" as const, label: "collect", tone: "var(--amber)" },
  { value: "d" as const, label: "interrupt", tone: "var(--violet)" },
  { value: "e" as const, label: "lanes", tone: "var(--amber)" },
];
