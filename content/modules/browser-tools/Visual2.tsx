...
const COPY = {
  "en": {
    "topic1": "concept 1 · browser-tools",
    "topic2": "concept 2 · browser-tools",
    "topic3": "concept 3 · browser-tools",
  ...
  "es": {
    "topic1": "Una página no es browser",
    "topic2": "El supervisor CDP",
    "topic3": "Cuándo browser, cuándo extract",
