...
const COPY = {
  "en": {
    "topic1": "concept 1 · openrouter-presets",
    "topic2": "concept 2 · openrouter-presets",
    "topic3": "concept 3 · openrouter-presets",
  ...
  "es": {
    "topic1": "OpenRouter no es un modelo",
    "topic2": "El preset: configuración guardada, no magia",
    "topic3": "Basic Info",
