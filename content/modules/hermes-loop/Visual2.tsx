...
const COPY = {
  "en": {
    "topic1": "concept 1 · hermes-loop",
    "topic2": "concept 2 · hermes-loop",
    "topic3": "concept 3 · hermes-loop",
  ...
  "es": {
    "topic1": "`run_conversation` es la cintura",
    "topic2": "Tres modos de API, un formato interno",
    "topic3": "Un turno, en orden",
