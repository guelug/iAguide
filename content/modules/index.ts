...
> = {
  ...
  "oauth-and-keys:3": () => import("./oauth-and-keys/Visual3"),
  ...
  "unsloth:4": () => import("./unsloth/Visual4"),
  ...
  "claude-code-and-codex:3": () => import("./claude-code-and-codex/Visual3"),
  ...
  "embeddings-and-retrieval:4": () => import("./embeddings-and-retrieval/Visual4"),
  ...
  "hermes-acp:3": () => import("./hermes-acp/Visual3"),
  ...
  "hermes-providers:3": () => import("./hermes-providers/Visual3"),
  ...
  "huggingface-hub:3": () => import("./huggingface-hub/Visual3"),
  "huggingface-hub:4": () => import("./huggingface-hub/Visual4"),
  "huggingface-inference:2": () => import("./huggingface-inference/Visual2"),
  "huggingface-inference:3": () => import("./huggingface-inference/Visual3"),
  ...
  "memory-hardware:4": () => import("./memory-hardware/Visual4"),
  "memory-hardware:5": () => import("./memory-hardware/Visual5"),
  "memory-hardware:6": () => import("./memory-hardware/Visual6"),
  ...
  "openclaw-gateway:3": () => import("./openclaw-gateway/Visual3"),
  ...
  "tools-runtime:3": () => import("./tools-runtime/Visual3"),
