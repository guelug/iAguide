...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-gateway",
    "topic2": "concept 2 · openclaw-gateway",
    "topic3": "concept 3 · openclaw-gateway",
  ...
  "es": {
    "topic1": "La cintura es un proceso",
    "topic2": "Componentes y flujos",
    "topic3": "Ciclo de vida de conexion",
