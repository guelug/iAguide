...
const COPY = {
  "en": {
    "topic1": "concept 1 · hermes-acp",
    "topic2": "concept 2 · hermes-acp",
    "topic3": "concept 3 · hermes-acp",
  ...
  "es": {
    "topic1": "AIAgent sobre ACP stdio",
    "topic2": "Flujo de arranque",
    "topic3": "HermesACPAgent y SessionManager",
