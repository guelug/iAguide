...
const COPY = {
  "en": {
    "topic1": "concept 1 · openclaw-cron",
    "topic2": "concept 2 · openclaw-cron",
    "topic3": "concept 3 · openclaw-cron",
  ...
  "es": {
    "topic1": "El scheduler vive en el Gateway",
    "topic2": "Kinds de schedule y timezone",
    "topic3": "Estilos de sesion",
