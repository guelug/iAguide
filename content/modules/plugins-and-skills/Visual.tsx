...
const OPTIONS = [
  { value: "discover" as const, label: "discover", tone: "var(--teal)" },
  { value: "manifest" as const, label: "manifest", tone: "var(--teal)" },
  { value: "register" as const, label: "register", tone: "var(--amber)" },
  { value: "skill" as const, label: "SKILL.md", tone: "var(--violet)" },
  { value: "index" as const, label: "skills index", tone: "var(--amber)" },
];
