...
const COPY = {
  "en": {
    "topic1": "concept 1 · unsloth-qwen38-run",
    "topic2": "concept 2 · unsloth-qwen38-run",
    "topic3": "concept 3 · unsloth-qwen38-run",
  ...
  "es": {
    "topic1": "Después del adapter, la caja en la que tiene q",
    "topic2": "Hardware: 4-bit 16–19GB es el 27B junto al que",
    "topic3": "No pongas el 2.4T en un portátil",
