...
const COPY = {
  "en": {
    "topic1": "concept 1 · model-zoo",
    "topic2": "concept 2 · model-zoo",
    "topic3": "concept 3 · model-zoo",
  ...
  "es": {
    "topic1": "Tres tipos de \"abierto\"",
    "topic2": "Dense frente a MoE",
    "topic3": "Los tamaños son un idioma, no una nota",
