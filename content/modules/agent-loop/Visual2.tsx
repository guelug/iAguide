...
const COPY = {
  "en": {
    "topic1": "concept 1 · agent-loop",
    "topic2": "concept 2 · agent-loop",
    "topic3": "concept 3 · agent-loop",
  ...
  "es": {
    "topic1": "Un turno, cinco verbos",
    "topic2": "Thought, Action, Observation: el while",
    "topic3": "Alfred y el tiempo en Nueva York",
